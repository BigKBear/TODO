angular.module("todoapp").controller('TodoController', function($scope, TodoService) {
	...
	$scope.getAll = function() {
		TodoService.getAllTodos().then(function(res) {
			//success
	...
	$scope.addTodo = function() {
		TodoService.addTodo($scope).then(function(res) {
			//success
		}, function(err) {
			//error
		});
	...
	$scope.deleteTodo = function(todoId) {
		TodoService.deleteTodo(todoId).then(function(res) {
			//success
		}, function(err) {
			//error
		});
	...
	$scope.updateTodo = function(todoId, olddata) {
		TodoService.updateTodo(todoId, olddata).then(function(res) {
			//success
		}, function(err) {
			//error
		});
